...
<footer class="bg-cenco-indigo text-white mt-auto position-relative overflow-hidden w-100" style="border-top: 6px solid var(--cenco-green);">
    ...
    <div class="container-fluid px-3 px-xl-5 py-5 position-relative z-1">
        ...
        <div class="row g-4 justify-content-between">
            ...
            <div class="col-lg-3 col-md-6 mb-4 mb-lg-0">
                <img src="<?= BASE_URL ?>img/logo.png" alt="Cencocal S.A." height="55" class="d-block bg-white rounded-3 p-2 mb-3 shadow-sm" style="width: auto;">
            ...
            <div class="col-lg-2 col-md-6 mb-4 mb-lg-0">
                ...
                <ul class="list-unstyled">
                    <li><a href="<?= BASE_URL ?>home" class="footer-link"><i class="bi bi-chevron-right me-1" style="font-size: 0.8rem;"></i> Inicio</a></li>
                    <li><a href="#" class="footer-link" data-bs-toggle="modal" data-bs-target="#nosotrosModal"><i class="bi bi-chevron-right me-1" style="font-size: 0.8rem;"></i> Nosotros</a></li>
                    <li><a href="<?= BASE_URL ?>home/catalogo" class="footer-link"><i class="bi bi-chevron-right me-1" style="font-size: 0.8rem;"></i> Catálogo de Productos</a></li>
                    <li><a href="<?= BASE_URL ?>home/locales" class="footer-link"><i class="bi bi-chevron-right me-1" style="font-size: 0.8rem;"></i> Locales y Horarios</a></li>
                    <li><a href="<?= BASE_URL ?>home/terminos" class="footer-link"><i class="bi bi-chevron-right me-1" style="font-size: 0.8rem;"></i> Términos Legales</a></li>
                </ul>
            </div>

            <div class="col-lg-2 col-md-6 mb-4 mb-md-0">
                <h5 class="footer-heading">Trabaja con nosotros</h5>
                <div class="trabaja-card shadow-sm">
                    <i class="bi bi-people-fill fs-1 text-white opacity-50 mb-2"></i>
                    <p class="small mb-3 lh-sm text-white opacity-75">¿Buscas nuevos desafíos profesionales?</p>
                    <a href="https://forms.gle/eMtt81QhDws5PSn7A" target="_blank" class="btn-trabaja">
                        Postular Aquí <i class="bi bi-box-arrow-up-right ms-1" style="font-size: 0.8rem;"></i>
                    </a>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-6 mb-4 mb-md-0">
                ...
                <ul class="list-unstyled d-flex flex-column gap-3">
                    ...
                    <li class="d-flex align-items-center gap-3">
                        ...
                        <a href="mailto:tiendaonline@cencocal.cl" class="footer-text small text-decoration-none text-white">tiendaonline@cencocal.cl</a>
                    </li>
                </ul>
            </div>
            ...
            <div class="col-lg-2 col-md-12">
                ...
                <div class="mb-3">
                    <span class="d-block text-white opacity-50 small mb-2 text-uppercase fw-bold" style="font-size: 0.7rem;">Medios de Pago Seguros</span>
                    <div class="trust-badge shadow-sm">
                        <img src="<?= BASE_URL ?>img/webpay-logo.png" alt="Webpay Plus Transbank">
                    </div>
                </div>

                <div>
                    <span class="d-block text-white opacity-50 small mb-2 text-uppercase fw-bold" style="font-size: 0.7rem;">Nuestras Alianzas</span>
                    <div class="row g-2">
                        <div class="col-12">
                            <div class="trust-badge shadow-sm">
                                <img src="<?= BASE_URL ?>img/soysociocrcp2025.png" alt="Socio CRCP Valparaíso">
                            </div>
                        </div>
                        <div class="col-6">
                            <a href="https://www.chep.com/cl/es-419/why-chep" target="_blank" class="text-decoration-none">
                                <div class="trust-badge shadow-sm p-2" title="Conoce por qué usamos CHEP">
                        ...
                        <div class="col-6">
                            <a href="https://almasend.app/" target="_blank" class="text-decoration-none">
                                <div class="trust-badge shadow-sm p-2" title="Logística por Almasend">
    ...
    <div class="border-top border-white border-opacity-10 py-4 mt-2">
        <div class="container-fluid px-3 px-xl-5 text-center">
            <p class="mb-0 small text-white opacity-50 font-monospace" style="letter-spacing: 1px;">
...
<div class="modal fade" id="nosotrosModal" tabindex="-1" aria-hidden="true" style="z-index: 1070;">
        ...
        <div class="modal-content rounded-4 border-0 shadow-lg overflow-hidden">
            ...
            <div class="modal-body p-4 bg-light">
                <ul class="nav nav-pills nav-fill mb-4 p-1 bg-white rounded-pill shadow-sm" id="pills-tab" role="tablist">
                    <li class="nav-item" role="presentation"><button class="nav-link active rounded-pill fw-bold" id="pills-objetivo-tab" data-bs-toggle="pill" data-bs-target="#pills-objetivo" type="button">Objetivo</button></li>
                    <li class="nav-item" role="presentation"><button class="nav-link rounded-pill fw-bold" id="pills-mision-tab" data-bs-toggle="pill" data-bs-target="#pills-mision" type="button">Misión</button></li>
                    <li class="nav-item" role="presentation"><button class="nav-link rounded-pill fw-bold" id="pills-vision-tab" data-bs-toggle="pill" data-bs-target="#pills-vision" type="button">Visión</button></li>
                    <li class="nav-item" role="presentation"><button class="nav-link rounded-pill fw-bold" id="pills-valores-tab" data-bs-toggle="pill" data-bs-target="#pills-valores" type="button">Valores</button></li>
                </ul>
                ...
                <div class="tab-content" id="pills-tabContent">
                    <div class="tab-pane fade show active" id="pills-objetivo" role="tabpanel">
                        <div class="bg-white p-4 rounded-4 shadow-sm border-start border-5 border-cenco-green h-100">
                            ...
                            <p class="text-muted text-justify mb-0">Mantenernos como la mejor distribuidora de abarrotes de la zona norte y centro de nuestro país, con altas expectativas de crecimiento geográfico en base a la <strong>conveniencia y confianza</strong> consolidada con nuestros clientes.<br><br>Nos basamos en el <strong>compromiso y agilidad</strong> en la entrega de nuestro amplio portafolio, asegurando una total satisfacción y experiencia de servicio.</p>
                        </div>
                    </div>
                    <div class="tab-pane fade" id="pills-mision" role="tabpanel">
                        <div class="bg-white p-4 rounded-4 shadow-sm border-start border-5 border-primary h-100">
                            ...
                            <p class="text-muted text-justify mb-0">Convertirse en la compañía de distribución más conveniente y confiable a lo largo de nuestro país.<br><br>Lograremos esto a través del <strong>compromiso, ética y desarrollo</strong> de nuestros colaboradores, satisfaciendo las necesidades de nuestros clientes y creando valor real en cada producto entregado.</p>
                        </div>
                    </div>
                    <div class="tab-pane fade" id="pills-vision" role="tabpanel">
                        <div class="bg-white p-4 rounded-4 shadow-sm border-start border-5 border-warning h-100">
                            ...
                            <p class="text-muted text-justify mb-0">Ser la <strong>distribuidora líder en el mercado nacional</strong>, alcanzando una expansión geográfica exponencial junto con un crecimiento financiero sólido.<br><br>Buscamos estar siempre a la <strong>vanguardia</strong> de los cambios que exigen nuestros clientes y fortalecer nuestras alianzas estratégicas.</p>
                        </div>
                    </div>
                    <div class="tab-pane fade" id="pills-valores" role="tabpanel">
                        <div class="bg-white p-4 rounded-4 shadow-sm h-100">
                            ...
                            <div class="row g-3">
                                <div class="col-md-6"><div class="p-3 bg-light rounded-3 h-100"><h6 class="fw-bold text-dark mb-2"><i class="bi bi-check-circle-fill text-success me-2"></i>Ética y Compromiso</h6><p class="small text-muted mb-0">Actuamos con integridad profesional, generando confianza en cada relación comercial.</p></div></div>
                                <div class="col-md-6"><div class="p-3 bg-light rounded-3 h-100"><h6 class="fw-bold text-dark mb-2"><i class="bi bi-lightbulb-fill text-warning me-2"></i>Iniciativa e Innovación</h6><p class="small text-muted mb-0">Buscamos siempre nuevas formas de mejorar y crecer junto a nuestros clientes.</p></div></div>
                                <div class="col-md-12"><div class="p-3 bg-light rounded-3"><h6 class="fw-bold text-dark mb-2"><i class="bi bi-people-fill text-primary me-2"></i>Orientación al Cliente y Equipo</h6><p class="small text-muted mb-0">Nuestro pilar son nuestros colaboradores. Fomentamos un liderazgo participativo y un ambiente de crecimiento personal y laboral.</p></div></div>
                            </div>
                        </div>
                    </div>
                </div>
