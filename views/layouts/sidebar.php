<?php if (isset($esAdmin) && $esAdmin): ?>
    ...
    <?php
    // Lógica para detectar página activa (integrada aquí para que funcione en el layout)
    ...
    <div class="offcanvas offcanvas-start rounded-end-4" tabindex="-1" id="adminSidebar" aria-labelledby="adminSidebarLabel" style="width: 300px; z-index: 1055;">
        ...
        <div class="offcanvas-body p-0">
            <div class="list-group list-group-flush py-3">
                ...
                <a href="<?= BASE_URL ?>admin/chorizo" 
                   class="list-group-item list-group-item-action border-0 px-4 py-2 mb-1 d-flex align-items-center gap-3 rounded-end-pill me-2 <?= isActiveAdmin('admin/chorizo', $currentUrl) ?>">
                    <i class="bi bi-images"></i> Auditoría de Fotos
                </a>
