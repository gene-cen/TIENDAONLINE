<div class="container-fluid px-4 py-4 bg-light min-vh-100">
    ...
    <?php 
        ...
        // Asumiendo IDs estándar: 1:Pendiente, 2:Pagado, 3:En Ruta, 4:Entregado, 5:Anulado
        // Si tu base de datos usa otros IDs, ajústalos en el <select> de abajo.
        ...
        <div class="col-lg-4">
            ...
            <div class="card border-0 shadow-sm rounded-4 mb-4 bg-cenco-indigo text-white">
                <div class="card-body p-4">
                    ...
                    <form action="<?= BASE_URL ?>admin/pedido/cambiarEstado" method="POST">
                        ...
                        <div class="input-group mb-3">
                            <select name="estado_id" class="form-select border-0 fw-bold text-cenco-indigo">
                                <option value="1" <?= $estadoIdActual == 1 ? 'selected' : '' ?>>Pendiente</option>
                                <option value="2" <?= $estadoIdActual == 2 ? 'selected' : '' ?>>Pagado</option>
                                <option value="3" <?= $estadoIdActual == 3 ? 'selected' : '' ?>>En Ruta</option>
                                <option value="4" <?= $estadoIdActual == 4 ? 'selected' : '' ?>>Entregado</option>
                                <option value="5" <?= $estadoIdActual == 5 ? 'selected' : '' ?>>Anulado</option>
                            </select>
