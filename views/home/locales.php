...
<style>
    ...
    @media (max-width: 991px) { .border-end-lg { border-right: none; border-bottom: 1px solid #eee; } }
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-lg-5 bg-white border-end-lg d-flex flex-column">
                            ...
                            <div class="position-relative" style="height: 250px; overflow: hidden;">
                                <img src="<?= $imgSrc ?>" 
                                     alt="<?= htmlspecialchars($local['nombre']) ?>" 
                            ...
                            <div class="p-4 flex-grow-1 d-flex flex-column justify-content-center">
                                <h4 class="fw-bold text-cenco-indigo mb-3"><?= htmlspecialchars($local['nombre']) ?></h4>
                                ...
                                <ul class="list-unstyled text-muted small spacing-list mb-0">
                                    <li class="mb-2 d-flex">
                                        ...
                                        <div>
                                            ...
                                            <span class="d-block"><?= htmlspecialchars($local['direccion']) ?></span>
                                            <small class="text-cenco-indigo fw-bold">
                                                <?= htmlspecialchars($local['nombre_comuna']) ?>, <?= htmlspecialchars($local['nombre_region']) ?>
                                            </small>
                                        </div>
                                    </li>
                                    ...
                                    <li class="mb-2 d-flex">
                                        ...
                                        <div>
                                            ...
                                            <?= htmlspecialchars($local['horario']) ?>
                                        </div>
                                    </li>
                                    ...
                                    <li class="d-flex">
                                        ...
                                        <div>
                                            ...
                                            <a href="mailto:<?= $local['email'] ?>" class="text-decoration-none text-cenco-indigo fw-bold"><?= htmlspecialchars($local['email']) ?></a>
                                        </div>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div class="col-lg-7">
                            <div id="map-<?= $index ?>" style="width: 100%; height: 100%; min-height: 500px;" class="bg-light"></div>
                        </div>
